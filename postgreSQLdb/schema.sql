...
-- SQLINES DEMO *** olving primary key question id
);
...
CREATE TABLE answers (
    ...
    -- SQLINES DEMO *** olving primary key question id if i switch to postgres
...
CREATE TABLE answerPhotos (
    ...
    -- SQLINES DEMO ***  PRIMARY KEY (photoID),
    -- SQLINES DEMO *** KEY (photoID)
);
